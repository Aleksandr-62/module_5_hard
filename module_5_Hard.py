...
class User:
    ...
    """
    Класс пользователь:  Содержит логин, хеш пароля, возраст
    """
...
class Video:
    """
    Класс описывающий характеристики видео контента: название, продалжительность,
...
class UrTube:
    """
    Класс собирающий все данные в единую конструкцию
    """
    def __init__(self):
